...
public class LogIn {
     ...
     * are incorrect.
     */
    public String logIn(String username, String password, useCase.OrganizerActions organizerActions, useCase.SpeakerActions speakerActions, useCase.AttendeeActions attendeeActions) {
        useCase.LoginActions l = new LoginActions();
     ...
     */
    public void signUp(useCase.OrganizerActions organizerActions, useCase.SpeakerActions speakerActions,
     ...
     */
    private boolean signUpCheck(String username, String password, useCase.OrganizerActions organizerActions, useCase.SpeakerActions speakerActions,
                                useCase.AttendeeActions attendeeActions) {
