...
public class UserController {
    ...
    /**
     * @return the username from the hashmap
     */
    ...
    /**
     * @return ID of the user from the hashmap
     */
    ...
    /**
     * Delete a user from the contact list of another user
     *
     * @param removeMe the username who will be removed
     * @param toMe     the username who's contact list that is updated
     * @return boolean true if contact was successfully removed, false if it was not
     */
     ...
     *
     * @param username the username whose eventsList is being checked
     * @param dateTime datetime that is being checked
     * @return true if there is a conflict, return false it there isn't
     */
